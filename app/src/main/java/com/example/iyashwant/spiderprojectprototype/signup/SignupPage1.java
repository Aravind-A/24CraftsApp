package com.example.iyashwant.spiderprojectprototype.signup;
...
import com.example.iyashwant.spiderprojectprototype.utils.CustomAdapterSpinner;
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectedcraft.equals("Actor") || selectedcraft.equals("Actress") || selectedcraft.equals("Child Artist") || selectedcraft.equals("Dancer") || selectedcraft.equals("Side Artists")){
                    ...
                    Intent goToNextActivity = new Intent(getApplicationContext(), SignupPage2.class);
                ...
                {
                    name=name1.getText().toString();
                    Intent goToNextActivity = new Intent(getApplicationContext(), SignupPage3.class);
                    Bundle bundle = new Bundle();
                    bundle.putString("name",name);
                    bundle.putString("craft",selectedcraft);
                    goToNextActivity.putExtras(bundle);
